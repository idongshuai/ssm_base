...
// DongShuai-side-menu向左折叠
$('.DongShuai-side-menu').click(function() {
  var sideWidth = $('#DongShuai-side').width();
  if(sideWidth === 200) {
      $('#DongShuai-body').animate({
        left: '0'
      }); //admin-footer
      $('#DongShuai-footer').animate({
        left: '0'
      });
      $('#DongShuai-side').animate({
        width: '0'
      });
  } else {
      $('#DongShuai-body').animate({
